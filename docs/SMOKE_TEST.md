...
`npm install -g ./kapel/release/devfallingstar-kapel-0.8.2.tgz`. 제거는
...
배너(`kapel v0.8.2  claude-sonnet-5  session 0f3c9a2b`)와 `kapel>` 프롬프트가
...
배너가 `kapel v0.8.2  claude-code · opus  session 0f3c9a2b` 형태로 뜨고, 그
