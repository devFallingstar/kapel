...
`npm install -g ./kapel/release/devfallingstar-kapel-0.3.0.tgz`. 제거는
...
배너(`kapel v0.3.0  claude-sonnet-5  session 0f3c9a2b`)와 `kapel>` 프롬프트가
뜨면 대화로 버그 수정을 지시합니다:
...
배너가 `kapel v0.3.0  claude-code · opus  session 0f3c9a2b` 형태로 뜨고, 그
